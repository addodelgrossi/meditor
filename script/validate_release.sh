...
test "$(plutil -extract CFBundleShortVersionString raw "$QUICK_LOOK_INFO")" = "$EXPECTED_MARKETING_VERSION"
test "$(plutil -extract CFBundleVersion raw "$QUICK_LOOK_INFO")" = "$EXPECTED_BUILD_NUMBER"
